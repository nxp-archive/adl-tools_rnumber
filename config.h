...
#if 0
#define RNUMBER_CXX_HAVE_NAMESPACES 1
/* #undef RNUMBER_CXX_HAVE_AUTO_PTR */
#define RNUMBER_CXX_HAVE_MEMBER_TEMPLATES 1
#define RNUMBER_CXX_HAVE_MUTABLE 1
#define RNUMBER_CXX_HAVE_PARTIAL_SPECIALIZATION 1
