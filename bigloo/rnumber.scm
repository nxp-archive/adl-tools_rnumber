...
(define (rn=? a b)
  (let ((first-rn (RNumber_proxy_t? a))
	...
	(second-ui (integer? b)))
    (cond ((and first-rn second-rn) (bl-rnumber-rn-equal-rn a b))
...
(define (rn!=? a b)
  (let ((first-rn (RNumber_proxy_t? a))
	...
	(second-rn (RNumber_proxy_t? b))
	(second-ui (integer? b)))
    (cond ((and first-rn second-rn) (bl-rnumber-rn-notequal-rn a b))
	  ((and first-rn second-ui) (bl-rnumber-rn-notequal-ui a b))
	  ((and first-ui second-rn) (bl-rnumber-ui-notequal-rn a b))
	  (else (error "rn!=?" *rnumber-two-arg-error* (cons a b))))))
...
(define (rn<? a b)
  (let ((first-rn (RNumber_proxy_t? a))
	...
	(second-rn (RNumber_proxy_t? b))
	(second-ui (integer? b)))
    (cond ((and first-rn second-rn) (bl-rnumber-rn-lessthan-rn a b))
...
(define (rn<=? a b)
  (let ((first-rn (RNumber_proxy_t? a))
	...
	(second-rn (RNumber_proxy_t? b))
	(second-ui (integer? b)))
    (cond ((and first-rn second-rn) (bl-rnumber-rn-lessequal-rn a b))
...
(define (rn>? a b)
  (let ((first-rn (RNumber_proxy_t? a))
	...
	(second-rn (RNumber_proxy_t? b))
	(second-ui (integer? b)))
    (cond ((and first-rn second-rn) (bl-rnumber-rn-greaterthan-rn a b))
...
(define (rn>=? a b)
  (let ((first-rn (RNumber_proxy_t? a))
	...
	(second-rn (RNumber_proxy_t? b))
	(second-ui (integer? b)))
    (cond ((and first-rn second-rn) (bl-rnumber-rn-greaterequal-rn a b))
