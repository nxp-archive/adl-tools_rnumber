(module rnumber
   ...
   (extern
    ...
    (rnumber-ui-multiply-rn::RNumber_proxy_t (uint RNumber_proxy_t) "bl_rnumber_ui_multiply_rn")
...
(define (rn* a b)
   (let ((first-rn (RNumber_proxy_t? a))
	 ...
	 (second-rn (RNumber_proxy_t? b))
	 (second-ui (integer? b)))
      (cond ((and first-rn second-rn) (rnumber-rn-multiply-rn a b))
	    ((and first-rn second-ui) (rnumber-rn-multiply-ui a b))
	    ((and first-ui second-rn) (rnumber-ui-multiply-rn a b))
	    ((and first-ui second-ui) (rn* (rnumber-ctor a) (rnumber-ctor b)))
	    (else (error "rn*" *rnumber-two-arg-error* (cons a b))))))
