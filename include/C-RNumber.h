...
struct RNumber * rnumber_create_from_string( const char * number  );
struct RNumber * rnumber_create_from_string_variable_sizing( const char * number );
struct RNumber * rnumber_create_from_string_of_size( const char * number, unsigned int size );
struct RNumber * rnumber_create_from_string_of_size_variable_sizing(  const char * number, unsigned int size );
struct RNumber * rnumber_create_from_string_of_radix( const char * number, int radix );
struct RNumber * rnumber_create_from_string_of_radix_variable_sizing( const char * number, int radix );
struct RNumber * rnumber_create_from_string_of_size_of_radix( const char * number, unsigned int size, int radix);
struct RNumber * rnumber_create_from_string_of_size_of_radix_variable_sizing( const char * number, unsigned int size, int radix);
